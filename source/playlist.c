...
void pl_draw_top(const Playlist *pl)
{
    ...
    if (pl->count == 0) {
        if (pl->use_favorites) {
            draw_text(30, 100, 0.52f, th->text_disabled, "Aucun favori !");
            draw_text(20, 125, 0.45f, th->text_disabled, "Ajoute des favoris avec L");
            draw_text(20, 145, 0.45f, th->text_disabled, "dans le navigateur de fichiers");
        } else {
